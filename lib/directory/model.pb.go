...
type DirectoryResponse struct {
	...
	Directories []*DirCollection  `protobuf:"bytes,2,rep,name=directories,proto3" json:"directories,omitempty"`
}
...
func (x *DirectoryResponse) GetDirectories() []*DirCollection {
	if x != nil {
...
func (x *DirCollection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DirCollection) ProtoMessage() {}

func (x *DirCollection) ProtoReflect() protoreflect.Message {
	mi := &file_directory_model_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DirCollection.ProtoReflect.Descriptor instead.
func (*DirCollection) Descriptor() ([]byte, []int) {
	return file_directory_model_proto_rawDescGZIP(), []int{3}
}

func (x *DirCollection) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DirCollection) GetSize() string {
	if x != nil {
		return x.Size
	}
	return ""
...
var file_directory_model_proto_rawDesc = []byte{
	...
	,
	...
	0x7a, 0x65, 0x42, 0x15, 0x5a, 0x13, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x6c, 0x69, 0x62, 0x2f,
...
var file_directory_model_proto_goTypes = []interface{}{
	...
	(*FileCollection)(nil),    // 2: directory.model.FileCollection
	(*DirCollection)(nil),     // 3: directory.model.DirCollection
}
var file_directory_model_proto_depIdxs = []int32{
	2, // 0: directory.model.DirectoryResponse.files:type_name -> directory.model.FileCollection
	3, // 1: directory.model.DirectoryResponse.directories:type_name -> directory.model.DirCollection
